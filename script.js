...
document.querySelector(".hydrogen").addEventListener('click', (event) => {
    ...
    document.querySelector('.data .mew').innerHTML = `${gamma[1]*(field.value)} at ${larmor.value} MHz for <sup>2</sup>H`;
...
document.querySelector(".lithium").addEventListener('click', (event) => {
    ...
    document.querySelector('.data .mew').innerHTML = `${gamma[3]*(field.value)} at ${larmor.value} MHz for <sup>2</sup>H`;
...
document.querySelector(".boron").addEventListener('click', (event) => {
    ...
    document.querySelector('.data .mew').innerHTML = `${gamma[6]*(field.value)} at ${larmor.value} MHz for <sup>2</sup>H`;
...
document.querySelector(".carbon").addEventListener('click', (event) => {
    ...
    document.querySelector('.data .mew').innerHTML = `${gamma[8]*(field.value)} at ${larmor.value} MHz for <sup>2</sup>H`;
    document.querySelector('.data .que').style.display = 'none';
    document.querySelector('.data .supque').style.display = 'none';
});
...
document.querySelector(".nitrogen").addEventListener('click', (event) => {
    ...
    document.querySelector('.data .mew').innerHTML = `${Math.abs(gamma[10]*(field.value))} at ${larmor.value} MHz for <sup>2</sup>H`;
    document.querySelector('.data .que').style.display = 'none';
    document.querySelector('.data .supque').style.display = 'none';
});
...
document.querySelector(".chlorine").addEventListener('click', (event) => {
    ...
    document.querySelector('.data .mew').innerHTML = `${gamma[21]*(field.value)} at ${larmor.value} MHz for <sup>2</sup>H`;
